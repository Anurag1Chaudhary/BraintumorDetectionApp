package com.example.braindetectionapp;
...
import com.example.braindetectionapp.ml.TfLiteBinaryEpochs100;
        ...
        predict.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (img != null) {
                    ...
                    try {
                        TfLiteBinaryEpochs100 model = TfLiteBinaryEpochs100.newInstance(getApplicationContext());
                        ...
                        if (outputFeature0.getIntArray()[0] == 1) {
                            output.setText("Yes, Brain Tumor Found");
                            output.setTextColor(Color.parseColor("#FF0000"));
                        } else {
                            output.setText("No, Brain Tumor not Found");
                            output.setTextColor(Color.parseColor("#ff00ff00"));
                        }
